...
export const LandingPage: React.FC<LandingPageProps> = ({ onStart }) => {
  return (
    <div className="min-h-screen w-full bg-[#BBC5AE] p-4 md:p-6 lg:p-8 flex items-center justify-center font-['Outfit'] selection:bg-black/10">
      ...
      {/* Main Inner Container - Removed fixed height, added min-height so it scrolls! */}
      <div className="relative w-full min-h-[calc(100vh-2rem)] bg-white rounded-[32px] overflow-hidden shadow-2xl flex flex-col">
        ...
        <div className="relative z-10 flex flex-col h-full w-full max-w-5xl mx-auto">
          ...
          {/* Hero Section */}
          <div className="flex-1 flex flex-col items-center mt-20 md:mt-32 px-4 text-center pb-24">
            ...
            <button 
              ...
              className="bg-black text-white hover:bg-black/80 shadow-lg font-semibold text-[16px] py-4 px-10 rounded-full transition-all hover:-translate-y-1 hover:shadow-xl active:scale-95 mb-16"
            >
              Start Free Trial
            </button>

            {/* Floating Glassmorphism Cards - Adapted for FinSight Features */}
